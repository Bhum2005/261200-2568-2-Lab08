...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Turtle tao1 = new Turtle();
        Turtle tao2 = new Turtle();
        Turtle tao3 = new Turtle();
        Thread t1 = new Thread(new Turtleslave(tao1,"Sun"));
        Thread t2 = new Thread(new Turtleslave(tao2,"Moon"));
        Thread t3 = new Thread(new Turtleslave(tao3,"Eclipse"));
        t1.start();
        t2.start();
        t3.start();
    }
